export default function ReturnsRefunds() {
  return (
    <div className="flex min-h-screen flex-col gap-4 px-20">
      <h1 className="py-8 text-3xl">Warranty & Return Policy</h1>

      <p className="mb-4 font-bold">
        All items sold by Parted Euro for their listed price do not include any
        forms of warranty or insurance.
      </p>
      ...
      <p className="mb-4">
        We view Brakes and Hydraulics as a safety item. Due to these being used
        parts, we cannot foresee the durability and reliability of these
        products, and therefore cannot guarantee their lasting performance. All
        used items that fit these categories will have a detailed description of
        their condition. Buyer agrees to these terms by purchasing any brake and
        hydraulic related item.
      </p>

      <p className="mb-4">
        Electronic components can potentially appear faulty, or be damaged upon
        install due to other external sources interfering. For this reason, we
        cannot offer warranty on any electrical products. Buyer agrees to these
        terms by purchasing any electronic related item.
      </p>

      <p className="mb-4">
        If an item is returned under warranty within the 30 day period, we will
        aim to source you a replacement, free of charge. If we cannot find a
        suitable replacement, a 20% restocking fee will incur.
      </p>
      ...
      <h2 className="mb-3 text-xl font-bold">
        Parted Euro will warrant/return an item if the following terms are met:
      </h2>
      ...
      <ul className="mb-4 list-disc pl-5">
        ...
        <li>
          The part(s) show signs of incorrect installation, or have been damaged
          in an attempt to install them.
        </li>
